...
8.4
# mid360总结
启动launch文件：diablo_bringup.launch
节点与文件位置：
激光雷达（2）
1. 激光雷达驱动---livox_ros_driver2---/msg_MID360_launch.py
2. 点云转换------pointcloud_to_laserscan

mqtt通信（2）
1. ros_to_mqtt_publisher
2. mqtt_to_ros_node
