...
#include "nav2_recoveries/plugins/drive_on_heading.hpp"
...
using BackUpAction = nav2_preview_msgs::action::BackUp;

namespace pb_nav2_recoveries
{

/**
 * @class pb_nav2_recoveries::BackUpFreeSpace
 * @brief An enhanced back_up action that move toward free space
 */
class BackUpFreeSpace : public nav2_recoveries::DriveOnHeading<nav2_preview_msgs::action::BackUp>
{
public:
   ...
   */
  nav2_recoveries::Status onRun(const std::shared_ptr<const BackUpAction::Goal> command) override;
